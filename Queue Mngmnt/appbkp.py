...
#                 # Check for "No Mask" class (Assume class 1 = "No Mask")
#                 if label.lower() == "mask_weared_incorrect":
#                     no_mask_detections += 1
#                     cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 2)
#                     cv2.putText(frame, f'{label}', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1)
#                 else:
#                     cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
#                     cv2.putText(frame, f'{label}', (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)

#         # Log detections to the database if "No Mask" detected
#         if no_mask_detections > 0:
#             log_detection(camera_id, no_mask_detections)
#             no_mask_detections = 0  # Reset count after logging
